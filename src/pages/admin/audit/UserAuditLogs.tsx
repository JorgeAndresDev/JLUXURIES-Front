        ...
        () => [
            ...
            },
            {
                ...
                cell: (info) => {
                    ...
                    return (
                        <span className="text-gray-700 dark:text-gray-300 text-sm truncate max-w-xs block">
                            {details || '-'}
                        </span>
                    );
                },
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-2 text-lg">
                            Historial de actividad de <span className="text-gray-900 dark:text-white font-semibold">{user?.nombre || user?.email}</span>
                        </p>
                    </div>
                    <Link
                        to="/admin"
                ...
                <div className="bg-white dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-xl dark:shadow-none">
                    {loading ? (
                        ...
                        <div className="text-center py-20">
                            <p className="text-gray-500 dark:text-gray-400 text-lg">No tienes acciones registradas</p>
                        </div>
                    ) : (
                        <>
