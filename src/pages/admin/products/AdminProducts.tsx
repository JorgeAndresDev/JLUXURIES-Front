        ...
        () => [
            ...
            },
            {
                ...
                cell: (info) => {
                    ...
                    return (
                        <span
                            className={`px-2.5 py-1 rounded-lg text-sm font-medium ${qty > 10
            ...
            },
            {
                ...
                cell: (info) => (
                    <div className="flex gap-2">
                        ...
                        <button
                            onClick={() =>
                                navigate(`/admin/edit-product/${info.row.original.idProducts}`)
                            }
                        ...
                        {/* Eliminar */}
                        <button
                            onClick={() => setDeleteConfirm(info.row.original.idProducts)}
